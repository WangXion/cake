...
// 排序
// exports.findSort = function(collectionName,json1,json2,callback){
//   /* 
//   collectionName:表名
//   json：查询条件,它是一个json对象，没有值默认为{}
//   json2：排序条件, 如{"id":1}1为升序，-1为降序
//   callback: 返回查询的数据
//   */
//   connectDb((db,client)=>{
//     // console.log(db);
//     let result = db.collection(collectionName).find(json1).sort(json2);
//     result.toArray((err,data)=>{
//       if (err) {
//         console.log(err);
//       }
...
// 分页
// exports.findlimit = function(collectionName,json,num,pagenum,callback){
//   /* 
//   collectionName:表名
//   json：查询条件,它是一个json对象，没有值默认为{}
//   num:每个页面数据条数
...
//   connectDb((db,client)=>{
//     // console.log(db);
//     let result = db.collection(collectionName).find(json).limit(num).skip(pagenum-1)*num;
//     result.toArray((err,data)=>{
//       if (err) {
//         console.log(err);
//       }
